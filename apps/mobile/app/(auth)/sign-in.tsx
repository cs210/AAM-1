      ...
      >
        ...
        >
          <View className="gap-4">
            <UiText className="text-2xl font-semibold text-foreground">Sign in</UiText>
            ...
            <Button onPress={onSubmit} disabled={isLoading}>
              <UiText>{isLoading ? "Signing in…" : "Sign in"}</UiText>
            </Button>
            <View className="flex-row justify-center gap-1">
              <UiText className="text-muted-foreground text-sm">Don't have an account? </UiText>
              <UiText
